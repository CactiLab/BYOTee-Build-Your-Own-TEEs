...
2. Run `mkdir SSC` to make a directory called`SSC`. Dumped security sensitive application using the tool chain should be stored here to be copied to SD card.
