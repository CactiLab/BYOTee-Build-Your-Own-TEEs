...
HD_PWD='/home/safayat/HLS_Security_UB/self_projects/blake2s/blake2s_project/blake2s_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blake2s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blake2s.tcl
